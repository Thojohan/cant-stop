...
export function Decisions({ completedRow, handleNewGame, setPlayerArray }) {
  ...
  return (
    <div className="decision-container">
      ...
      <div className="button-container">
        ...
        <button className="main-button" onClick={continueHandler}>
          {!isRolling ? "Roll dice" : "Continue"}
        </button>
        <button className="main-button" onClick={stopHandler}>
          Stop
        </button>
      </div>
    </div>
...
function Result({ el, completedRow }) {
  return (
